...
add_edges(g, src = e$src[11:20], dst = e$dst[11:20])
...
expect_error( add_edges(g, src = e$src[11:20], dst = e$dst[11:20]))

# Adding no edges should to nothing
add_edges(g, src = integer(0), dst = integer(0))
e_tst <- get_edgelist(g)
expect_equal(e_tst$src, e$src)
expect_equal(e_tst$dst, e$dst)
expect_equal(e_tst$weights, rep(1, 20))
...
# Add invalid edges
expect_error(add_edges(g, src = 100, dst = 100))
...
add_edges(g, src = e$src[11:20], dst = e$dst[11:20], weights = e$w[11:20])
...
# Adding no edges should to nothing
add_edges(g, src = integer(0), dst = integer(0), weights = numeric(0))
e_tst <- get_edgelist(g)
expect_equal(e_tst$src, e$src)
expect_equal(e_tst$dst, e$dst)
stopifnot(isTRUE(all.equal(e_tst$weights, e$w, tolerance = 1E-6)))
...
# Add invalid edges
expect_error(add_edges(g, src = 100, dst = 100, weights = 10))



add_edges(g, src = 10, dst = 10, weights = NULL)
